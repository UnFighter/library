...
Route::delete('/user/{user}/book/{book}', [BookController::class, 'destroyBookUserConnection'])->name('user.destroyConnection');
Route::post('/user/{user}/book/{book}/create', [BookController::class, 'createBookUserConnection'])->name('user.createConnection');
